...
uses Windows, SysUtils, Registry, ActiveX,
  ComObj, {$IFDEF DELPHI6_PLUS}Variants,{$ENDIF} StdVCL,
...
// *********************************************************************//
  IHTMLDocDisp = dispinterface
    ...
    procedure CreateComponent(const Id: WideString; const Html: WideString; ReplaceWnd: Int64); dispid 205;
...
// *********************************************************************//
  ...
  private
    ...
    function GetSafeURL(const Filename: WideString;
...
function TVirtualUI.GetSafeURL(const Filename: WideString; Minutes: Integer): WideString;
begin
  Result := Filename;
  if Assigned(FVirtualUI) then
...
procedure THTMLDoc.CreateComponent(const Id, Html: WideString;ReplaceWnd: Int64);
begin
