...
Namespace Cybele.Thinfinity
    ...
    <ComVisible(True), Guid("1C5700BC-2317-4062-B614-0A4E286CFE68"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("4D9F5347-460B-4275-BDF2-F2738E7F6757"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("A5A7F58C-D83C-4C89-872E-0C51A9B5D3B0"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    Public Interface IHTMLDoc
        Sub CreateSessionURL(url As String, filename As String)
        Sub CreateComponent(Id As String, Html As String, ReplaceWnd As Int64)
    ...
    <Guid("B3EAC0CA-D7AB-4AB1-9E24-84A63C8C3F80"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("439624CA-ED33-47BE-9211-91290F29584A"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("6DE2E6A0-3C3A-47DC-9A93-928135EDAC90"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("E492419B-00AC-4A91-9AE9-9A82B07E89AE"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    Public Interface IJSNamedValue
        Inherits IJSValue
        Property Name() As String
    End Interface

    <Guid("59342310-79A7-4B14-8B63-6DF05609AE30"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <ComVisible(True), Guid("A3D640E8-CD18-4196-A1A2-C87C82B0F88B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("C2406011-568E-4EAC-B95C-EF29E4806B86"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("1F95C0E9-E7BF-48C9-AA35-88AD0149109B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("FCBB688F-8FB2-42C1-86FC-0AAF3B2A500C"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("8F8C4462-D7B5-4696-BAD5-16DFAA6E2601"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    Public Interface IJSArgument
        Inherits IJSNamedValue
    End Interface

    <Guid("FC097EF5-6D8A-4C80-A2AD-382FDC75E901"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("C45D6A8F-AD4A-47BB-AC3A-C125D6D5D27E"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("E4CB461F-586E-4121-ABD7-345B87BC423A"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("8B66EACD-9619-43CF-9196-DCDA17F5500E"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("6AE952B3-B6DA-4C81-80FF-D0A162E11D02"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <ComVisible(True), Guid("ACFC2953-37F1-479E-B405-D0BB75E156E6"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    Public Interface IJSBinding
        Sub [Set](Parent As IJSObject, Prop As IJSProperty)
    End Interface

    <ComVisible(True), Guid("ADD570A0-491A-4E40-8120-57B4D1245FD3"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("D89DA2B6-B7BF-4065-80F5-6D78B331C7DD"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("D4744AE1-70CB-43DD-BEA5-A5310B2E24C6"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    Public Interface IRecTrack
        ReadOnly Property Name As String
        ReadOnly Property Position As Integer
    End Interface

    <Guid("AB45B615-9309-471E-A455-3FE93F88E674"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    Public Interface IRecTracks
        ReadOnly Property Item(Index As Integer) As IRecTrack
        ReadOnly Property Count As Integer
    End Interface

    <Guid("3FE99D2F-0CFC-43D1-B762-0C7C15EB872E"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    <Guid("4834F840-915B-488B-ADEA-98890A04CEE6"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)> _
    ...
    Public Class VirtualUILibrary
        ...
        End Function
        <DllImport("kernel32.dll")> _
        Private Shared Function GetPrivateProfileString(lpAppName As String, _
                    lpKeyName As String, _
                    lpDefault As String, _
                    lpReturnedString As StringBuilder, _
                    nSize As Integer, _
    ...
    Public Class HTMLDoc
        ...
        ''' </summary>
        Public Sub CreateComponent(Id As String, Html As String, ReplaceWnd As IntPtr)
            CreateComponent(Id, Html, ReplaceWnd.ToInt64)
        End Sub

        Public Sub CreateComponent(Id As String, Html As String, ReplaceWnd As Int64) Implements IHTMLDoc.CreateComponent
            If m_VirtualUI IsNot Nothing Then
    ...
    <ClassInterface(ClassInterfaceType.AutoDual), ComSourceInterfaces(GetType(IEvents))> _
