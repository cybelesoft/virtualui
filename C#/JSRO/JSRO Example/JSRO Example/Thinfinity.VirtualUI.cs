...
namespace Cybele.Thinfinity
{
    ...
    public interface IEvents
    {
        ...
        [DispId(203)]
        void OnDragFile2(DragAction Action, Int32 ScreenX, Int32 ScreenY, string Filenames, out bool Accept);
        [DispId(204)]
        void OnDropFile(Int32 ScreenX, Int32 ScreenY, string Filenames, string FileSizes, out string IgnoreFiles);
    }
    ...
    public interface IHTMLDoc
    {
        ...
        string CreateForwarding(string url);
    }
    ...
    {
        int ContentionTime { get; set; }
        int NewWindowContentionTime { get; set; }
    }
    ...
    {
        ImageEncodingType Format { get; set; }
    ...
    {
        IImageDelivery Delivery { get; set; }
        IImageEncoding Encoding { get; set; }
    }
   ...
   */
    ...
    public class HTMLDoc : IHTMLDoc, IDisposable
    {
        ...
        /// <summary>
        ///   Creates a http(s) forwarding to the specified url.
        /// </summary>
        public string CreateForwarding(string url)
        {
            if (m_VirtualUI != null)
                return m_VirtualUI.HTMLDoc.CreateForwarding(url);
            else return "";
        }
    ...
    */
    ...
    public class DragFile2Args : EventArgs {
        public DragAction Action { get; set; }
    ...
    public class DropFileArgs : EventArgs {
        public Int32 ScreenX { get; set; }
        public Int32 ScreenY { get; set; }
        public String Filenames { get; set; }
    ...
    internal sealed class VirtualUISink : IEvents
    {
        ...
        public void OnDragFile2(DragAction Action, Int32 ScreenX, Int32 ScreenY, String Filenames, out bool Accept) {
            m_VirtualUI.OnDragFile2EventHandler(Action, ScreenX, ScreenY, Filenames == null ? "" : Filenames, out Accept);
        }
        public void OnDropFile(Int32 ScreenX, Int32 ScreenY, String Filenames, String FileSizes, out String IgnoreFiles) {
            m_VirtualUI.OnDropFileEventHandler(ScreenX, ScreenY, Filenames == null ? "" : Filenames, FileSizes == null ? "" : FileSizes, out IgnoreFiles);
        }
        #endregion
    ...
    public class VirtualUI : VirtualUILibrary,  IDisposable
    {
        ...
        ///   FileName outs whit the full path of uploaded file.
        /// </summary>
        ...
        /// <summary>
        ///   Contains methods to modify the streaming performance.
        /// </summary>
        ...
        /// <summary>
        ///   DEPRECATED: Use DragFile2 and DropFile instead.
        ///   Fires when the DragFile method.
        /// </summary>
        [Obsolete("DragFile event is deprecated. Use DragFile2 and DropFile instead.")]
        ...
        ///   DragFile2 event.
        /// </summary>
        private event EventHandler<DragFile2Args> m_OnDragFile2;
        public event EventHandler<DragFile2Args> OnDragFile2 {
            add {
                if (g_virtualUI != this) {
                    g_virtualUI.OnDragFile2 += value;
                    return;
                }
                m_OnDragFile2 += value;
            }
        ...
        ///   DropFile event.
        /// </summary>
        private event EventHandler<DropFileArgs> m_OnDropFile;
        public event EventHandler<DropFileArgs> OnDropFile {
            add {
                if (g_virtualUI != this) {
                    g_virtualUI.OnDropFile += value;
                    return;
                }
                m_OnDropFile += value;
            }
        ...
        internal void OnDragFile2EventHandler(DragAction Action, Int32 ScreenX, Int32 ScreenY, string Filenames, out bool Accept) {
            if (m_OnDragFile2 != null) {
                DragFile2Args args = new DragFile2Args();
                args.Action = Action;
                args.ScreenX = ScreenX;
                args.ScreenY = ScreenY;
                args.Filenames = Filenames;
                args.Accept = false;
                m_OnDragFile2(this, args);
                Accept = args.Accept;
            }
            else {
                Accept = false;
        ...
        internal void OnDropFileEventHandler(Int32 ScreenX, Int32 ScreenY, string Filenames, string FileSizes, out string IgnoreFiles) {
            IgnoreFiles = "";
            if (m_OnDropFile != null) {
                DropFileArgs args = new DropFileArgs();
                args.ScreenX = ScreenX;
                args.ScreenY = ScreenY;
                args.Filenames = Filenames;
                args.FileSizes = FileSizes;
                args.IgnoreFiles = IgnoreFiles;
                m_OnDropFile(this, args);
