...
Namespace Cybele.Thinfinity
    ...
    Public Interface IVirtualUI
        ...
        Function UploadFileEx(ByRef FileName As String) As Boolean
        ...
        ReadOnly Property Performance() As IPerformance
    End Interface
    ...
    Public Interface IEvents
        ...
        <DispId(203)>
        Sub OnDragFile2(Action As DragAction, ScreenX As Integer, ScreenY As Integer, Filenames As String, ByRef Accept As Boolean)
        <DispId(204)>
        Sub OnDropFile(ScreenX As Integer, ScreenY As Integer, Filenames As String, FileSizes As String, ByRef IgnoreFiles As String)
    End Interface
    ...
    Public Interface IHTMLDoc
        ...
        Function CreateForwarding(url As String) As String
    End Interface
    ...
    <Guid("627D6FDB-04B7-42E8-945A-2D91ECE891E9"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)>
    Public Interface IImageDelivery
        Property ContentionTime As Integer
        Property NewWindowContentionTime As Integer
    End Interface

    <Guid("FEE77B14-8072-4700-AE67-11EA0ED7DA9A"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)>
    Public Interface IImageEncoding
        Property Format As ImageEncodingType
        Property JPEGQuality As Integer
    End Interface

    <Guid("0D05F614-FDE6-457E-82BD-8D8692D6BB1B"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch)>
    Public Interface IPerformance
        Property Delivery As IImageDelivery
        Property Encoding As IImageEncoding
    End Interface
    ...
    Public Class DropFileArgs
        ...
        End Property
        Private m_Filenames As String
        Public Property FileSizes() As String
            Get
                Return m_FileSizes
            End Get
            Set(value As String)
            ...
            End Set
        End Property
        Private m_FileSizes As String
        Public Property IgnoreFiles() As String
            Get
            ...
            End Set
        End Property
        Private m_IgnoreFiles As String
    End Class
...
#Region "VirtualUISink Members"
        ...
        End Sub
        Public Sub OnDragFile2(Action As DragAction, ScreenX As Integer, ScreenY As Integer, Filenames As String, ByRef Accept As Boolean) Implements IEvents.OnDragFile2
            m_VirtualUI.OnDragFile2EventHandler(Action, ScreenX, ScreenY, Filenames, Accept)
        End Sub
        Public Sub OnDropFile(ScreenX As Integer, ScreenY As Integer, Filenames As String, FileSizes As String, ByRef IgnoreFiles As String) Implements IEvents.OnDropFile
            m_VirtualUI.OnDropFileEventHandler(ScreenX, ScreenY, Filenames, FileSizes, IgnoreFiles)
        End Sub
...
#End Region
    ...
    Public Class VirtualUI
        ...
        Public Function UploadFileEx(ByRef FileName As String) As Boolean 'Implements IVirtualUI.UploadFileEx
            Return UploadFileEx("", FileName)
        End Function

        Public Function UploadFileEx(ServerDirectory As String, ByRef FileName As String) As Boolean 'Implements IVirtualUI.UploadFileEx
            If m_VirtualUI IsNot Nothing Then
        ...
        Public Function UploadDroppedFiles(ServerDirectory As String, IgnoreFiles As String, ByRef FileNames As String) As Boolean 'Implements IVirtualUI.UploadDroppedFiles
            If m_VirtualUI IsNot Nothing Then
                Return m_VirtualUI.UploadDroppedFiles(ServerDirectory, IgnoreFiles, FileNames)
            End If
            Return False
        End Function
        ...
        Public ReadOnly Property HTMLDoc() As IHTMLDoc
            Get
                Return m_VirtualUI.HTMLDoc
            End Get
        End Property

        Public ReadOnly Property Performance() As IPerformance
            Get
                Return m_VirtualUI.Performance
            End Get
        End Property
        ...
        Public Custom Event OnDragFile2 As EventHandler(Of DragFile2Args)
            AddHandler(ByVal value As EventHandler(Of DragFile2Args))
                If Not Me.Equals(g_virtualUI) Then
                    g_virtualUI.Events.AddHandler("OnDragFile2", value)
                    Return
                End If
                Me.Events.AddHandler("OnDragFile2", value)
            End AddHandler
            RemoveHandler(ByVal value As EventHandler(Of DragFile2Args))
                If Not Me.Equals(g_virtualUI) Then
                    g_virtualUI.Events.RemoveHandler("OnDragFile2", value)
                    Return
                End If
                Me.Events.RemoveHandler("OnDragFile2", value)
            End RemoveHandler
            RaiseEvent(ByVal sender As Object, ByVal args As DragFile2Args)
                If Not IsNothing(Me.Events("OnDragFile2")) Then
                    CType(Me.Events("OnDragFile2"), EventHandler(Of DragFile2Args)).Invoke(sender, args)
                End If
            End RaiseEvent
        End Event

        Public Custom Event OnDropFile As EventHandler(Of DropFileArgs)
            AddHandler(ByVal value As EventHandler(Of DropFileArgs))
                If Not Me.Equals(g_virtualUI) Then
                    g_virtualUI.Events.AddHandler("OnDropFile", value)
                    Return
                End If
                Me.Events.AddHandler("OnDropFile", value)
            End AddHandler
            RemoveHandler(ByVal value As EventHandler(Of DropFileArgs))
                If Not Me.Equals(g_virtualUI) Then
                    g_virtualUI.Events.RemoveHandler("OnDropFile", value)
                    Return
                End If
                Me.Events.RemoveHandler("OnDropFile", value)
            End RemoveHandler
            RaiseEvent(ByVal sender As Object, ByVal args As DropFileArgs)
                If Not IsNothing(Me.Events("OnDropFile")) Then
                    CType(Me.Events("OnDropFile"), EventHandler(Of DropFileArgs)).Invoke(sender, args)
                End If
            End RaiseEvent
        End Event
        ...
        Friend Sub OnDragFile2EventHandler(Action As DragAction, ScreenX As Integer, ScreenY As Integer, Filenames As String, ByRef Accept As Boolean)
            Dim args As New DragFile2Args()
            args.Action = Action
            args.ScreenX = ScreenX
            args.ScreenY = ScreenY
            args.Filenames = Filenames
            args.Accept = Accept
            RaiseEvent OnDragFile2(Me, args)
            Accept = args.Accept
        End Sub

        Friend Sub OnDropFileEventHandler(ScreenX As Integer, ScreenY As Integer, Filenames As String, FileSizes As String, ByRef IgnoreFiles As String)
            Dim args As New DropFileArgs()
            args.ScreenX = ScreenX
            args.ScreenY = ScreenY
            args.Filenames = Filenames
            args.FileSizes = FileSizes
            args.IgnoreFiles = IgnoreFiles
            RaiseEvent OnDropFile(Me, args)
