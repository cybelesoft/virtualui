...
Namespace Cybele.Thinfinity
    ...
    Public Interface IVirtualUI
        ...
        Sub Suspend()
        Sub Resume_()
        Sub ForceOwnerWindow(Wnd As Long,All As Boolean)
...
#End Region
    ...
    Public Class VirtualUI
        ...
        Public Sub ForceOwnerWindow(Wnd As Long,All As Boolean) 'Implements IVirtualUI.ForceOwnerWindow
            If m_VirtualUI IsNot Nothing Then
                m_VirtualUI.ForceOwnerWindow(Wnd,All)
            End If
        End Sub
