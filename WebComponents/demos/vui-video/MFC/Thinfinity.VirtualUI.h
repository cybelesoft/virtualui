...
private:
	...
	int GetAsInteger(DISPPARAMS* args, int index);
	void SetInteger(DISPPARAMS* args, int index, int value);
	bool GetAsBoolean(DISPPARAMS* args, int index);
	void SetBoolean(DISPPARAMS* args, int index, bool value);
	VARIANT_BOOL GetAsVariantBool(DISPPARAMS* args, int index);
	void SetVariantBool(DISPPARAMS* args, int index, VARIANT_BOOL value);
    std::wstring GetAsString(DISPPARAMS* args, int index);
    void SetString(DISPPARAMS* args, int index, std::wstring value);
	BSTR GetAsBSTR(DISPPARAMS* args, int index);
	void SetBSTR(DISPPARAMS* args, int index, BSTR value);
