...
Namespace Cybele.Thinfinity
    ...
    Public Interface IPrinter
        ...
        Function PrintFile(PrintType As Integer, FileName As String, PrinterName As String) As Boolean
    ...
    Public Class RemotePrinter
        ...
        Public Sub LastError(ByRef ErrorCode As Integer, ByRef ErrorMessage As String)
            ...
            ElseIf LibHandle = IntPtr.Zero Then
        ...
        ''' <summary>
        ''' Send the file to the print job of the default remote printer. 
        ''' If the print job is sent successfully, this result true.
        ''' Otherwise the LastError inform that happend.
        ''' </summary>
        Public Function PrintFile(PrintType As Integer, FileName As String, PrinterName As String) As Boolean
            If m_RemotePrinter IsNot Nothing Then
