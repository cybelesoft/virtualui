...
// *********************************************************************//
  IVirtualUI = interface(IDispatch)
    ...
    procedure ForceOwnerWindow(Wnd: Integer; ForceAll: WordBool); safecall;
...
// *********************************************************************//
  IVirtualUIDisp = dispinterface
    ...
    procedure ForceOwnerWindow(Wnd: Integer; ForceAll: WordBool); dispid 208;
  end;
...
// *********************************************************************//
  ...
  public
    ...
    procedure Resume; safecall;
	/// <summary>
	///   Sets a window as main window for the application,
  ///   forcing virtualui to set this window as owner of modal dialogs.
	/// </summary>
...
procedure TVirtualUI.ForceOwnerWindow(Wnd: Integer; ForceAll: WordBool);
begin
  if Assigned(FVirtualUI) then
    FVirtualUI.ForceOwnerWindow(Wnd,ForceAll);
end;
